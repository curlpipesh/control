    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        if(args.length == 1) {
            ...
            if((essUser = getEssentials().getOfflineUser(playerName)) != null) {
                ...
                punishments.addAll(getControl().getInactivePunishments().getPunishmentsForUUID(essUser.getConfigUUID()));
                punishments.addAll(getControl().getActivePunishments().getPunishmentsForUUID(essUser.getConfigUUID()));
