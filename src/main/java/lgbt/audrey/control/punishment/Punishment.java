package lgbt.audrey.control.punishment;
...
public class Punishment {
     ...
     * The main plugin.
     */
    private final AudreyPlugin control;
    ...
    public Punishment(@NonNull final AudreyPlugin control, @NonNull final int id, @NonNull final PunishmentType type,
